...
export interface CompanionProfile {
  ...
  hobbies: string;
  catchphrase: string;
  // Physical / NSFW attributes — used in photo generation & chat descriptions
  bodyType?: string;       // e.g. 'slim', 'athletic', 'curvy', 'petite'
  breastSize?: string;     // e.g. 'small', 'medium', 'large', 'extra large'
  hairColor?: string;      // e.g. 'blonde', 'brunette', 'black', 'pink'
  hairStyle?: string;      // e.g. 'long straight', 'short bob', 'twin tails'
  skinTone?: string;       // e.g. 'fair', 'olive', 'tan', 'dark'
  height?: string;         // e.g. '150cm', '163cm', '172cm'
  specialFeatures?: string; // e.g. 'tattoo on hip', 'pierced navel', 'beauty mark'
}
...
export const COMPANIONS: Companion[] = [
  {
    ...
    profile: {
      ...
      skinTone: 'fair',
      height: '163cm',
      specialFeatures: 'light freckles on cheeks',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      breastSize: 'large',
      hairColor: 'black',
      hairStyle: 'sleek straight shoulder-length',
      skinTone: 'olive',
      height: '170cm',
      specialFeatures: 'sharp jawline, red lipstick, beauty mark near lips',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      skinTone: 'fair',
      height: '155cm',
      specialFeatures: 'big doe eyes, soft round face',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      hairStyle: 'elegant updo with loose strands',
      skinTone: 'light olive',
      height: '168cm',
      specialFeatures: 'mature elegance, subtle laugh lines, hourglass figure',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      breastSize: 'small',
      hairColor: 'black',
      hairStyle: 'long straight silky',
      skinTone: 'fair porcelain',
      height: '160cm',
      specialFeatures: 'delicate collarbones, slender neck, mysterious dark eyes',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      skinTone: 'golden tan',
      height: '167cm',
      specialFeatures: 'toned abs, belly button piercing, sun-kissed glow',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      skinTone: 'light tan',
      height: '165cm',
      specialFeatures: 'toned legs, visible abs, athletic build, sports bra tan lines',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      hairStyle: 'long straight elegant',
      skinTone: 'pale ivory',
      height: '173cm',
      specialFeatures: 'high cheekbones, piercing blue eyes, long elegant legs',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      breastSize: 'small',
      hairColor: 'black',
      hairStyle: 'straight with side-swept bangs',
      skinTone: 'fair porcelain',
      height: '152cm',
      specialFeatures: 'soft round face, small delicate hands, cute dimples',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      breastSize: 'large',
      hairColor: 'dark brown',
      hairStyle: 'tight bun with loose front strands',
      skinTone: 'caramel',
      height: '175cm',
      specialFeatures: 'muscular thighs, defined arms, tattoo on shoulder blade',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      hairStyle: 'loose curls past shoulders',
      skinTone: 'warm olive',
      height: '166cm',
      specialFeatures: 'full lips, warm brown eyes, soft voluptuous figure',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      bodyType: 'slim',
      breastSize: 'small',
      hairColor: 'pink with purple tips',
      hairStyle: 'messy medium-length with clips',
      skinTone: 'fair',
      height: '158cm',
      specialFeatures: 'colorful nail art, cat ear headphones around neck, small waist',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      hairStyle: 'sleek straight past shoulders',
      skinTone: 'pale ivory',
      height: '174cm',
      specialFeatures: 'sharp cheekbones, icy blue eyes, long slender legs, red nails',
    },
  ...
  },
  {
    ...
    profile: {
      ...
      hairStyle: 'soft waves with flower clips',
      skinTone: 'very fair with light freckles',
      height: '155cm',
      specialFeatures: 'rosy cheeks, dainty frame, delicate wrists, innocent doe eyes',
    },
